...
void AutoBalancer::solveFullbodyIK ()
{
  ...
  stopFootForEarlyTouchDown();
    ...
    }
    {
        ...
        double roll_weight, pitch_weight, fly_weight = 1e-3, normal_weight = 1e-6, weight_fly_interpolator_time = 1.0, weight_normal_interpolator_time = 1.5;
        // roll
        ...
        // 上半身関節角のq_refへの緩い拘束
        double upper_weight, fly_ratio = 0.0, normal_ratio = 1e-6;
